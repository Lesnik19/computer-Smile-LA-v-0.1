...
- 64 байта памяти (больше пока делать не стал, чтобы отрисока на мониторе не знамимала много времени), из которых 17 байт - порты ввода-вывода. Память - прошиваемая (подобие ROM, но прямо в оперативке)
