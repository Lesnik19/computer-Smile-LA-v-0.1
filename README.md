...
2. Откройте [эту карту в Logic Arrows](https://logic-arrows.io/map-cMzdZnXm) (рекомендую в настройках выбрать "Максимальное отдаление" на 2x или 3x).  
3. Поставьте скорость 60 или выше (60 конечно маловато, рекомендую использовать <a href="#thanks">расширение браузера</a> для ускорения игры).
